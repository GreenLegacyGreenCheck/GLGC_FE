    ...
    <>
      ...
      >
        ...
        <section className="bg-[#f2faf6] px-5 py-7 sm:py-5">
          <Link
            href="/upload"
            className="block w-full rounded-2xl bg-[#1ba77d] px-6 py-5 text-center text-xl font-black text-white shadow-lg shadow-emerald-800/10 transition hover:bg-[#168c6a] sm:py-4"
          >
            지금 시작하기
          </Link>
          ...
          >
            <h2 id="how-to-use" className="text-base font-black text-[#789b8c]">
              사용 방법
            </h2>
